              ...
              <div className="flex-col justify-start items-start gap-[10px] flex">
                <div className="h-[249px] px-[34px] flex-col justify-start items-start gap-[43px] flex">
                  <div className="justify-start items-center gap-[16px] inline-flex">
                    <div className="h-11 px-[13px] py-[11px] bg-[#d9d9d9]/10 rounded-[12px] justify-center items-center gap-2.5 flex">
                      <div className="text-[#ffffff] text-lg font-medium font-['Inter']  tracking-tight">
                        Chess
                      </div>
                    </div>
                    <div className="px-[13px] py-[11px] bg-[#d9d9d9]/10 rounded-[12px] justify-center items-center gap-2.5 flex">
                      <div className="text-[#ffffff] text-lg font-medium font-['Inter']  tracking-tight">
                        Clash Royal
                      </div>
                    </div>
